...
export const axiosInstance = axios.create({
  ...
  timeout: 3000,
  headers: {
    Authorization: `Bearer ${"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzMyMzM4Mjc5LCJpYXQiOjE3MzE3MzM0NzksImp0aSI6Ijc2NDljYjQyMWRlYTQyYTZhZTIyMTdhZDMxODJlOWI1IiwidXNlcl9pZCI6NX0.kEgSWc7noi9hCGRnNy63D5tzWmE3gTy47F6wkvqzpbg"}`,
  },
});
